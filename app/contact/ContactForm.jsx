...
export default function ContactForm() {
    ...
    return (
        <div className="bg-white py-10 lg:py-0 h-full lg:h-screen flex justify-center items-center font-dmsans">
            <div className="w-full max-w-[90%] lg:max-w-[50%] p-6 bg-white rounded-lg">
                <h1 className="text-4xl font-bold text-center text-black mb-2 font-rufina">Contact Form</h1>
                <h2 className="text-xl font-semibold text-center text-black mb-6 font-dmsans mx-0 lg:mx-10">We take our commitments to our users seriously. Reach us For any complaint or query.</h2>
                <form className="space-y-7 pt-5 font-dmsans" onSubmit={handleSubmit}>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 lg:gap-4 gap-x-8">
