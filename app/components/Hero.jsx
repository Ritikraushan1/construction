...
function Hero() {
    ...
    return (
        <div className=' relative bg-hero h-screen md:h-full lg:h-screen w-screen font-dmsans'>
            <div className=' w-screen h-screen bg-black bg-opacity-60 z-0'>
                ...
                <div className=" hidden lg:grid grid-rows-5 h-full z-50">
                    ...
                    <div className="grid grid-cols-7">
                        ...
                        <div className="border-[1px] border-white border-opacity-5 flex items-center justify-center z-50 cursor-pointer">
                            <h1 className="text-white text-xs text-center opacity-50">Repair<br /> and construction<br /> company</h1>
                        </div>
                        <div className="border-[1px] border-white border-opacity-5">
                            <h1 className="text-white text-2xl font-bold"></h1>
                        </div>
                        <div className="border-[1px] border-white border-opacity-5 z-50 cursor-pointer">
                    ...
                    <div className="grid grid-cols-7">
                        ...
                        <div className="border-[1px] border-white border-opacity-5 hover:bg-[#000000] hover:bg-opacity-100 cursor-pointer">
