        ...
        <div className='w-screen h-screen'>
            <div className=" grid grid-cols-1 lg:grid-cols-3 text-white grid-flow-col-dense">
                <div className="relative">
                    <div className="">
                        <img src="/images/img4.jpg" alt="project1" className=' w-full h-screen opacity-60 object-cover ' />
                    </div>
                ...
                <div className="relative h-full">
                    <div className="">
                        <img src="/images/img2.jpg" alt="project1" className='w-full h-screen opacity-60 object-cover' />
                    </div>
                    <div className="absolute bottom-10 left-10">
                ...
                <div className="relative h-full">
                    <div className="">
                        <img src="/images/img3.jpg" alt="project1" className='w-full h-screen opacity-60 object-cover' />
                    </div>
                    <div className="absolute bottom-10 left-10">
